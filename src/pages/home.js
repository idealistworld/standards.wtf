    ...
    return (
        <div className="outerlayer">
            <div class='rounded-xl flex items-center justify-center flex-wrap'>
                <div class='lg:w-[400px] sm:mr-0 md:w-[20%] md:mr-20 lg:mr-48 flex flex-col flex-wrap'>
                    <h1 class='text-7xl font-black max-sm:text-center max-sm:text-2xl'>ARE YOUR STANDARDS <span class='italic underline'>TOO HIGH?</span></h1>
                ...
                <div class='max-md:mt-[100px] max-sm:w-[90%] rounded-2xl bg-white py-10 px-5 drop-shadow-[15px_15px_rgba(0,0,0,0.8)] border-black border-[9px] w-[430px] flex flex-col'>
                    <img src={meme} ></img>
